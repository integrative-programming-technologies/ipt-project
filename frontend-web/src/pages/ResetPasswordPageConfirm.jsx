    ...
    return (
        <>
            <div className="container auth__container">
                <h1 className="main__title">RESET YOUR PASSWORD HERE</h1>
                ...
                <form className="auth__form">
                    ...
                    <input type="password"
                        ...
                        required
                    />
                    <button className="btn btn-primary" type="submit" onClick={handleSubmit}><AiFillLock /> Reset Password</button>
                </form>
            </div>
        </>
    )
